...
import FeUpload from '@/components/FeUpload';
import Region from '@/components/Region';
import { isNumber } from '@fe/validator';
import '../public/static/iconfontAli/iconfont.js';

isNumber.allZero = true;

Vue.component('layout', Layout);
Vue.component('fe-viewer', FeViewer);
Vue.component('fe-upload', FeUpload);
